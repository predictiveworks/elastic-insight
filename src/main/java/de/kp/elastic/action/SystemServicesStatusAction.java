...
public class SystemServicesStatusAction extends BaseRestHandler {

	private String ACTION_NAME = "SystemServicesStatusAction";
	...
	private SystemServicesStatusResult doRequest(RestRequest request) throws Exception {
		...
		if (request.hasContentOrSourceParam()) {
			...
			String json = AccessController.doPrivileged((PrivilegedAction<String>) () -> {
				return job.getSystemServicesStatusAsJson();	
