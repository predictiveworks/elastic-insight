# <img src="https://github.com/skrusche63/elastic-insight/blob/master/images/elastic-insight.svg" style="padding-top:5px;" height="32px" width="32px"> Elasticsearch Plugin for CDAP
